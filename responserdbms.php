...
<div class="container-fluid banner">
    ...
    <center> 
        ...
        <br><br><br><br>
        <h2>Response from RDBMS Class</h2>
 
        <br><br>
        <input type="text" value="https://forms.gle/qQa5kjeW4bAUX45i8" id="myInput">
        <button onclick="myFunction()" onmouseout="outFunc()" class="btn btn-primary"> Copy Link</button>
        
 
       
        <br><br><br>
        <iframe src='https://docs.google.com/spreadsheets/d/1xntXtSQOwxfFb5yw3XutBugY3h5wb-8IwztK5EC3QDU/edit#gid=230304352 path here' width='100%' height='565px' frameborder='0'> </iframe>
    </center>
