...
<div class="container-fluid banner">
    ...
    <center> 
        ...
        <br><br><br><br>
        <h2>Response from Web Class</h2>
        
        <br><br>
        <input type="text" value="https://forms.gle/rLu5cD8uN9Ro63bR7" id="myInput">
        <button onclick="myFunction()" onmouseout="outFunc()" class="btn btn-primary"> Copy Link</button>
        
 
       
        <br><br><br>
        <iframe src='https://docs.google.com/spreadsheets/d/1X6wljEDMuxd6-flyFXEJ-CNzMb_8Zf7-VhGpxLxpEEE/edit#gid=1912823312 path here' width='100%' height='565px' frameborder='0'> </iframe>
    </center>
