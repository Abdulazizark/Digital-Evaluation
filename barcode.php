            ...
            <div class="col-sm-6 ">
                <form class="form-container info" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="form-group" <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                        ...
                        <input type="url" class="form-control"  name="msg" value="<?php echo @$body; ?>"  placeholder="Message">
                    </div>
 
                    <button type="submit" class="btn btn-primary btn-block" formaction="qr.php" name="submit">Generate</a>
                    </button>
