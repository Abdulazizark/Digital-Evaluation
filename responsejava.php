...
<div class="container-fluid banner">
    ...
    <center> 
        ...
        <br><br><br><br>
        <h2>Response from JAVA Class</h2>
 
        <br><br>
        <input type="text" value="https://forms.gle/VJNuoLn6oSTLCm8D9" id="myInput">
        <button onclick="myFunction()" onmouseout="outFunc()" class="btn btn-primary"> Copy Link</button>
        
 
       
        <br><br><br>
        <iframe src='https://docs.google.com/spreadsheets/d/15WNWT4VuEtDh2wv0KtnZG8GY3NMIpVS1i9FduRmQx3s/edit#gid=2076518484 path here' width='100%' height='565px' frameborder='0'> </iframe>
    </center>
